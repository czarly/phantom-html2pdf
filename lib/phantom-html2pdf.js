...
function convert(options, callback) {
	...
	function(err, results) {
	    ...
	    var paperBorder = typeof paperSize.border == "string" ? paperSize.border : "1cm";
	    var paperBorderTop = paperSize.border.top || false;
	    var paperBorderBottom = paperSize.border.bottom || false;
	    var paperBorderLeft = paperSize.border.left || false;
	    var paperBorderRight = paperSize.border.right || false;
